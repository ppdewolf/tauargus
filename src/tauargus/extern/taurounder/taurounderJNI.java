...
public class taurounderJNI {
  ...
  public static void SwigDirector_RProgressListener_UpdateUpperBound(RProgressListener jself, double UpperBound) {
    jself.UpdateUpperBound(UpperBound);
  }
  public static void SwigDirector_RProgressListener_UpdateNumberClosedSubProb(RProgressListener jself, int ClosedSubProb) {
    jself.UpdateNumberClosedSubProb(ClosedSubProb);
  }
  public static void SwigDirector_RProgressListener_UpdateNumberOpenSubProb(RProgressListener jself, int OpenSubProb) {
    jself.UpdateNumberOpenSubProb(OpenSubProb);
  }
  public static int SwigDirector_RCallback_SetExtraTime(RCallback jself) {
    return jself.SetExtraTime();
  }
