...
public class TauArgus {
  ...
  public int SetCellKeyValuesCont(int TabNo, String PTableFileCont, String PTableFileSep, String CKMType, int topK, boolean IncludeZeros, boolean Parity, boolean Separation, double m1sqr, String Scaling, double s0, double s1, double xstar, double q, double[] epsilon) {
    return TauArgusJavaJNI.TauArgus_SetCellKeyValuesCont(swigCPtr, this, TabNo, PTableFileCont, PTableFileSep, CKMType, topK, IncludeZeros, Parity, Separation, m1sqr, Scaling, s0, s1, xstar, q, epsilon);
  }
